...
<div id="recipe-card" class="card mx-2" style="height: fit-content;">
    ...
    <div class="card-body pt-2 px-3 pb-0">
        <h5 class="card-title text-nowrap text-truncate fw-bolder fs-4" style="margin-block-end: 0;">Food Name</h2>
